...
"$PYTHON" scripts/train_mdeberta_ru_prompt_injection_option_b.py \
  --device cuda --bf16 \
  --student-model work/models/mdeberta-ru-prompt-injection-v12-critical-correction-ft \
  --prepared-dataset-dir datasets/prepared/training-dataset-v13-critical-russian-correction-windowed \
  --output-dir work/models/mdeberta-ru-prompt-injection-v13-critical-correction-ft \
  --learning-rate 1e-6 --epochs 1 --distill-weight 0.0 --skip-teacher \
